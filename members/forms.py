...
from final.models import Profile
...
class EditProfileForm(UserChangeForm):
    ...
    # last_login = forms.CharField(max_length=20, widget=forms.CheckboxInput(attrs={'class': 'form-check'}))
    # is_staff = forms.CharField(max_length=20, widget=forms.CheckboxInput(attrs={'class': 'form-check'}))
